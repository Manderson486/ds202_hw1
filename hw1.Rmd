...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Marcella Anderson** but I have gone by Marcy all my life. I am a *software engineering* major. I guess I'll write a few fun facts to fill out this paragraph. I'm an identical twin and I am older than her by 3 minutes. She goes to Iowa so I guess that means I'm the smarter twin. I have never had a pet. I am 5'6". I have a brother who is 19 and a little sister who is a freshman in highschool. I hope whoever is reading this is having a good day!
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: One job that probably uses a lot of data science is polling analysis. There is a lot of data involved in taking a poll and understanding that data would involve a lot of data science. One place they do this is at [538](fivethirtyeight.com). They use data science to try and predict the outcome of everything from presidential elections to sports outcomes. ![logo](https://talkingbiznews.com/wp-content/uploads/2019/10/fivethirtyeight-logo.jpg){width=10%}
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I'm not really that invested in any particular datasets, though covid data is topical so that might be kind of interesting to look at. 
